...
# Note: Using extension-based language detection instead of ML models
# This keeps the deployment lightweight and fast
MODELS_LOADED = False  # We're not using ML models for this deployment
...
def health_check():
    return jsonify({
        ...
        "mode": "extension-based detection",
